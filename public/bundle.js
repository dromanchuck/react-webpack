...
var _TaskList = __webpack_require__(28);
...
var App = function (_React$Component) {
    ...
    _createClass(App, [{
        ...
        value: function remove(val) {
            var index = this.state.data.indexOf(val);
        ...
        value: function render() {
            return _react2.default.createElement(
                'div',
                null,
                _react2.default.createElement(_Title2.default, { count: this.state.data.length }),
                _react2.default.createElement(_Input2.default, { addTodo: this.addTodo.bind(this) }),
                _react2.default.createElement(_TaskList2.default, { value: this.state.data, remove: this.remove.bind(this) })
            );
        }
    }]);
...
var _Task = __webpack_require__(29);
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                { onClick: function onClick() {
                        return _this2.props.handleClick(_this2.props.value);
                    } },
    ...
    _createClass(Input, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                { className: 'input' },
                _react2.default.createElement('textarea', { placeholder: placeholders[randomNumber],
